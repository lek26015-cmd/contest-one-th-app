...
import { getSubmissionsQuery } from '@/lib/submission-actions';
...
export default function ProfilePage() {
  ...
  const submissionsQuery = useMemoFirebase(() => {
    ...
    return getSubmissionsQuery(firestore, user.uid);
  }, [user, firestore]);
  ...
  const submissionHistory = useMemo(() => {
    ...
    const processedSubmissions = submissions.map(sub => {
      ...
      return {
        ...
        submissionDate: submissionDate // Now it's a Date object
      };
    });
