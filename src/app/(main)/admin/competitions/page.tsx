...
import { Trash2, Edit, PlusCircle, Search, Eye, Star, Layout } from 'lucide-react';
import {
  AlertDialog,
  AlertDialogAction,
  AlertDialogCancel,
                ...
                <div className="mt-6 space-y-4 max-h-[60vh] overflow-y-auto pr-4">
                    ...
                    filteredCompetitions.map(comp => (
                        ...
                        <div className="flex items-center gap-2">
                            ...
                            <Button variant="ghost" size="icon" asChild title="Landing Page Builder">
                                <Link href={`/admin/competitions/${comp.id}/landing-page`}>
