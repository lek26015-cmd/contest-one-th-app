...
import { addCompetition } from '@/lib/competition-actions';
...
export default function NewCompetitionPage() {
  ...
  async function onSubmit(values: CompetitionFormValues) {
    ...
    try {
      await addCompetition(firestore, {
        ...values,
        userId: user.uid,
      ...
      toast({
        title: "สร้างงานแข่งขันสำเร็จ!",
        description: "งานของคุณถูกเพิ่มลงในระบบเรียบร้อยแล้ว",
      });
  ...
  return (
    <div className="max-w-4xl mx-auto pb-20">
      <div className="mb-8 flex items-center gap-4">
        ...
        <div>
          <h1 className="text-3xl font-black text-slate-900 tracking-tight">สร้างงานแข่งขันใหม่</h1>
          <p className="text-slate-400 font-bold">ระบุข้อมูลให้ครบถ้วนเพื่อดึงดูดผู้สมัครที่ตรงกลุ่มเป้าหมาย</p>
        </div>
      </div>
          ...
          <div className="flex items-center justify-end gap-4 pt-4">
             ...
             >
               {isSubmitting ? (
                 ...
                 <>
                   <Check className="mr-2 h-6 w-6" /> ประกาศงานแข่งขัน
                 </>
               )}
             </Button>
          </div>
